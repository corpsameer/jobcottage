				...
				<div class="panel panel-login">
					<div class="panel-heading">
							<div class="col-xs-6 login_right_brdr">
								<a href="#" class="active" id="login-form-link"><?php echo get_record(79,$lang,$en);?></a>
							</div>
							<div class="col-xs-6">
								<a href="#" id="register-form-link"><?php echo get_record(92,$lang,$en);?></a>
							</div>
						<hr>
					</div>
							...
							<div class="col-lg-12">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="<?php echo get_record(79,$lang,$en);?>">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="<?php echo $site_url;?>login/forgot.php" tabindex="5" class="forgot-password"><?php echo get_record(95,$lang,$en);?></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="form-group col-md-6">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-login" value="<?php echo get_record(104,$lang,$en);?>">
											</div>
										</div>
									</div>
								</form>
