...
$setid=1;
		...
		{
			$secretkey = $setts['test_secret_key'];
		}
		else if($setts['stripe_mode']=="live")
		{
			$secretkey = $setts['live_secret_key'];
		}
...
<div class="min-space"></div>
    ...
    <h1 class="success-msg">Your Payment ID - <?php echo $stripe_token; ?>.</h1>
	</div>
	<div class="min-space"></div>
