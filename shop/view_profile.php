...
if(isset($_REQUEST['id']))
	{		
		$shop_id=mysqli_real_escape_string($con, $_REQUEST['id']);		
	}
	else
	{$shop_id="";}
?>
...
<div class="row">
<?php 
$shop_query=mysqli_fetch_array(mysqli_query($con, "select * from sv_shop where id='$shop_id'"));
...
<div class="row">
  ...
  <ul class="nav nav-tabs sv_nav_tab">
    <li class="active col-md-3"><a data-toggle="tab" href="#menu1"><?php echo get_record(46,$lang,$en,$con);?></a></li>
    <li class="col-md-2"><a data-toggle="tab" href="#home"><?php echo get_record(107,$lang,$en,$con);?></a></li>
    <li class="col-md-2"><a data-toggle="tab" href="#menu2"><?php echo get_record(108,$lang,$en,$con);?></a></li>
    <li class="col-md-2"><a data-toggle="tab" href="#menu3"><?php echo get_record(109,$lang,$en,$con);?></a></li>
	<li class="col-md-3"><a data-toggle="tab" href="#menu4"><?php echo get_record(128,$lang,$en,$con);?></a></li>
  </ul>
  </div>
  <div class="tab-content profile_det">
   ...
   <div id="menu1" class="tab-pane fade in active">
		...
		<div class="col-md-12">
		<?php 		
			$services_query=mysqli_query($con, "select * from sv_seller_services where phone_no='$pno'");
		...
		<div class="col-md-3">
			...
			<div class="col-md-6"><img src="<?php echo $site_url; ?>admincp/img/<?php echo $fetch['service_img']; ?>" border="0" class="img-responsive imgradius sv_mob_service_img" alt=""></div>
				...
				<!---<span class="icon_info" aria-hidden="true"></span>-->
					...
					<div class="col-md-12">
					<a href="<?php echo $site_url; ?>shop/view_booking.php?id=<?php echo $shop_id; ?>&service_id=<?php echo $services_id; ?>"><input type="submit" name="register-submit" id="register-submit" tabindex="4" class="booknow" value="<?php echo get_record(12,$lang,$en,$con);?>"></a>
    ...
    <div id="menu2" class="tab-pane fade">
		...
		$ratg=mysqli_query($con, "select * from sv_rating where shop_id='$shop_id'");
		$numrow=mysqli_num_rows($ratg);
		if($numrow=='0') { ?>
		 <div class="rating">
		<?php 
		...
		while($rating=mysqli_fetch_array($ratg))
		{
			$pno=$rating['phone_no'];
    ...
    <div id="menu3" class="tab-pane fade sv_gallery_image">
	  ...
	  <?php 
 		$gallery=mysqli_query($con, "select * from sv_shop_gallery where shop_id='$shop_id'");
		$sv_rows=mysqli_num_rows($gallery);
		while($sql=mysqli_fetch_array($gallery))
		{
	  if($sql['image']!="")
	  {
	  ?>
      <div class="col-md-3">
		...
		<?php }  }?>
	  <?php if($sv_rows=="") { ?>		  
	  <p style="color:#e00000;text-align:center;float:none;margin-top:20px;"><?php echo get_record(244,$lang,$en,$con);?></p>
		<?php }  ?>
    </div>
	 ...
	 <div id="menu4" class="tab-pane fade">
		...
		<input type="hidden" id="vendor_id" name="vendor_id" value="<?php echo $shop_id; ?>">
			<div class="col-md-6">
				<label><?php echo get_record(132,$lang,$en,$con);?></label>
				<input type="text"  name="name" id="name" class="form-control" required value="">
			</div>
			<div class="col-md-6">
				<label><?php echo get_record(133,$lang,$en,$con);?></label>
				<input type="number"  name="phone_no" id="phone_no" class="form-control" required value="">
			</div>
			<div class="col-md-6">
				<label><?php echo get_record(134,$lang,$en,$con);?></label>
				<input type="email"  name="email" id="email" class="form-control" required value="">
			</div>
			<div class="col-md-6">
				<label><?php echo get_record(135,$lang,$en,$con);?></label>
				<textarea name="message" id="message" class="form-control" required ></textarea>
			</div>
			<div class="col-md-2">
				<input type="submit" name="register-submit" id="register-submit" class="form-control btn btn-register" value="<?php echo get_record(137,$lang,$en,$con);?>">
			</div>
