...
<div class="row">
  ...
  <ul class="nav nav-tabs sv_tab">
    <li class="active col-md-4"><a data-toggle="tab" href="#home"><?php echo get_record(107,$lang,$en);?></a></li>
    <li class="col-md-4"><a data-toggle="tab" href="#menu1"><?php echo get_record(46,$lang,$en);?></a></li>
    <li class="col-md-4"><a data-toggle="tab" href="#menu2"><?php echo get_record(108,$lang,$en);?></a></li>
  ...
  <div class="tab-content profile_det">
    <div id="home" class="tab-pane fade in active">
		...
		<div class="col-md-6 contact_address">
			<h3><?php echo get_record(130,$lang,$en);?></h3>
				...
				<?php
				$query=mysql_fetch_array(mysql_query("select * from sv_shop where id='$id'"));
				$sid=$query['shop_date'];
			...
			<div class="col-md-6">
				<h3><?php echo get_record(138,$lang,$en);?> </h3>
    ...
    <div id="menu1" class="tab-pane fade">
		<div class="col-md-12">
		<?php 
			$services_query=mysql_query("select * from sv_seller_services where phone_no='$phone_no'");
    ...
    <div id="menu2" class="tab-pane fade">
		...
		<div class="rating">
		<?php
		$rating=mysql_fetch_array(mysql_query("select * from sv_rating where shop_id='$id'"));
		$s = $rating['rating'];
		$pno=$rating['phone_no'];
...
<div class="form-group col-md-6" >
	...
	<div class="form-group col-md-6" >
		...
		<?php
			$id1=$shop_query['id'];
			$query=mysql_fetch_array(mysql_query("select * from sv_shop where id='$id1' "));
			$sid=$query['shop_date'];
			$sel=explode(",",$sid);
			$lev=count($sel);				
		?>
...
?>
	...
	<div class="form-group">
		<div class="row">
			<div class="col-sm-2">
				<a href="shop.php?id=<?php echo $id;?>"><input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="<?php echo get_record(139,$lang,$en);?>"></a>
			</div>
			<div class="col-sm-2">
				<a href="<?php echo $site_url; ?>/services/services.php" target="_blank"><input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register sv_services_butt" value="<?php echo get_record(152,$lang,$en);?>"></a>
			</div>
		</div>
	</div>
	</div>
