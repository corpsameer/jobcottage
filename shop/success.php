...
$payment_status = $_GET['st'];
	...
	mysqli_query($con, "update sv_booking set status='paid',currency='$currency_code' where id='$item_number'");
...
<div class="min-space"></div>
    ...
    <h1 class="success-msg">Your Payment ID - <?php echo $item_number; ?>.</h1>
	</div>
	<div class="min-space"></div>
