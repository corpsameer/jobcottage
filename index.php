...
?>
	...
	<div id="example-03" class="ma5slider inside-navs hidden-dots inside-dots horizontal-navs hidden-navs horizontal-dots loop-mode anim-fade autoplay">
        <div class="slides">
            <?php 
				$slider_query=mysql_query("select * from sv_slider");
				while($slider_fetch=mysql_fetch_array($slider_query))
				{
				?>
	...
	<div class="main-form">
		<div class="col-md-3"></div>
          ...
          <h1> <?php echo get_record(1,$lang,$en);?></h1>
         <div class="homepage__separator"></div>
		 
		  <div class="col-md-12" align="center">
		  <div class="col-md-1" ></div>
		 <div class="col-md-10" >
		 <div class="homepage__subtitle"><?php echo get_record(2,$lang,$en);?></div>
		 </div>
		 <div class="col-md-1" ></div>
		 </div>
         ...
         <div class="col-md-1" ></div>
			...
			<option value="" title="<?php echo $site_url; ?>img/search.png"><?php echo get_record(7,$lang,$en);?></option>
			 <?php 
	...
	<h2 class="text-center"><?php echo get_record(8,$lang,$en);?> </h2>
	...
	<div class="featured-template__name"><?php echo get_record(9,$lang,$en);?></div>
	<div class="col-md-2"></div><div class="col-md-8 "><a href="#" class="form-control btn btn-login bookhandy"><?php echo get_record(10,$lang,$en);?></a></div><div class="col-md-2"></div>
	</div>
	</div>
...
<!-----------shop slider start here----------------->	
      ...
      <div class="container">
        <div class="large-12 columns">
          ...
          <div class="owl-carousel">
		   ...
		   <?php
					$shop=mysql_query("select * from sv_services where lang_code='$lang' ORDER BY id ASC");
					while($shop_fet=mysql_fetch_array($shop))
					{
			...
			<?php
					...
					<div class="ashbgg">						
						...
						<a href="<?php echo $site_url; ?>shop/search.php?services=<?php echo $ser_id; ?>" class="booknow shop-booknow sv_cleaner nofloat"><?php echo get_record(12,$lang,$en);?></a>
						</div>            </div>
          <?php } ?> 
	...
	<h2 class="text-center"><?php echo get_record(13,$lang,$en);?> </h2>
	...
	<div class="how-name"><?php echo get_record(21,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(22,$lang,$en);?></div>
	</div>
	</div>
	<div class="col-md-2"></div>
	...
	<div class="how-name"><?php echo get_record(23,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(24,$lang,$en);?></div>
	</div>
	...
	<div class="how-name"><?php echo get_record(32,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(33,$lang,$en);?></div>
	</div>
	...
	<div class="how-name"><?php echo get_record(34,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(35,$lang,$en);?></div>
	</div>
	...
	<div class="how-name"><?php echo get_record(36,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(37,$lang,$en);?></div>
	</div>
	...
	<div class="how-name"><?php echo get_record(38,$lang,$en);?></div>
	<div class="how-desc">
	<?php echo get_record(39,$lang,$en);?></div>
	</div>
...
<section id="carousel">    				
	<div class="container wow animated fadeIn">
	    <h2 class="testino-title"><?php echo get_record(40,$lang,$en);?> </h2>
        ...
        <div class="carousel-inner">
         <?php 
						$testi_query=mysql_query("select * from sv_testimonials where lang_code='$lang'");
						while($testi_fetch=mysql_fetch_array($testi_query))
						{
						?>
						<div class="item">
         <div class="col-md-10">
...
jQuery(document).ready(function() {
	...
	<div class="text-center easytxt"><h2><?php echo get_record(41,$lang,$en);?></h2></div>
...
<div class="container">
 ...
 <h2 class="text-center paddon60"><?php echo get_record(42,$lang,$en);?> </h2>
			<div class="col-md-2"></div>
				<div class="col-md-8" align="center">
				   <?php 
						$res1=mysql_query("select * from sv_services where lang_code='$lang' ORDER BY id");
