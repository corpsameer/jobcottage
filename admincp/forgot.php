...
<form class="form" action="javascript:forgot();">
	...
	<input class="form-control" type="" name="user" id="user" placeholder="User Name" >
	<div class="err" style="color:#e00000;" id="err_id"></div>

	<button class="btn btn-primary txt-center" type="submit" >Reset</button>
	<div class="err-msg" id="err_id"><?php echo $msg;?></div>
	<p data-style="mt:20" >Remembered your password ? <a href="index.php">Go Back</a></p>
</form>
</div>
				<div class="col-lg-4 col-md-4 col-sm-4"></div>
