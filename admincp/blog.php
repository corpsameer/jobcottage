...
if(isset($_REQUEST['bid']))
	{		
		...
		$res=mysqli_query($con, "select * from sv_blog where id='$bid'");
		...
		{			
			...
			$title=mysqli_real_escape_string($con, $fet['title']);	
...
?>	
		...
		{
		$viewpage=mysqli_query($con, "select * from sv_blog where id='$id' and page_parent='0'");
		...
		{ 
			...
			$viewpage=mysqli_query($con, "select * from sv_blog where lang_code='$langcode' and page_parent='$id'");
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										$sno=0;
										$res=mysqli_query($con, "select * from sv_blog where page_parent='0'");
