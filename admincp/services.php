...
if(isset($_REQUEST['sid']))
	{
		...
		$res=mysqli_query($con, "select * from sv_services where id='$sid'");
...
?>
	   ...
	   <div class="tab-content">
		...
		{
		$viewpage=mysqli_query($con, "select * from sv_services where id='$id' and page_parent='0'");
		...
		else
		{
			...
			$viewpage=mysqli_query($con, "select * from sv_services where lang_code='$langcode' and page_parent='$id'");
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
										$sno=0;
										$res=mysqli_query($con, "select * from sv_services where  page_parent='0'");
