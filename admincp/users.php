...
if(isset($_REQUEST['uid']))
	{		
		...
		$res=mysql_query("select * from sv_users where id='$uid'");
		...
		{			
			...
			$user_type=mysql_real_escape_string($fet['user_type']);	
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
									...
									<?php		
									$sno=0;
									$res=mysql_query("select * from sv_users ORDER BY id DESC");
