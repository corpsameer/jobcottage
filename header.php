...
<nav class="navbar navbar-default">
  <div class="container-fluid container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			?>
			  <li class="dropdown dropdown-submenu user_menu login-user"><a href="<?php echo $site_url; ?>login/dashboard.php" class="dropdown-toggle nav__link" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;<span><?php echo $query['user_name'];?></span> &nbsp; <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                         <li><a href="<?php echo $site_url; ?>login/dashboard.php"> <?php echo get_record(71,$lang,$en,$con);?></a></li>
						<li><a href="<?php echo $site_url; ?>shop/my_bookings.php"> <?php echo get_record(72,$lang,$en,$con);?></a></li>
						<?php if($usertype=="seller") { ?>
							<li><a href="<?php echo $site_url; ?>shop/myorder.php"> <?php echo get_record(73,$lang,$en,$con);?></a></li>
							<li><a href="<?php echo $site_url; ?>shop/shop.php"> <?php echo get_record(74,$lang,$en,$con);?></a></li>
							<li><a href="<?php echo $site_url; ?>services/services.php"> <?php echo get_record(75,$lang,$en,$con);?></a></li>
							<li><a href="<?php echo $site_url; ?>shop/gallery.php"> <?php echo get_record(76,$lang,$en,$con);?></a></li>
							<li><a href="<?php echo $site_url; ?>shop/withdraw.php"> <?php echo get_record(77,$lang,$en,$con);?></a></li>

						<?php } ?>
                         <li><a href="<?php echo $site_url; ?>login/logout.php"> <?php echo get_record(78,$lang,$en,$con);?></a></li>
                     </ul>
                </li>
				<?php } else { ?>
				<li ><a class="signin" href="<?php echo $site_url; ?>login/login.php"> <?php echo get_record(79,$lang,$en,$con);?> </a></li>
				<li ><a class="register" href="<?php echo $site_url; ?>login/login.php"> <?php echo get_record(92,$lang,$en,$con);?></a></li>
                <?php } ?>
	 ...
	 <ul id="lang">
	 <?php $active_one=mysqli_fetch_array(mysqli_query($con, "select * from sv_language where lang_status='1' and lang_code='$en' limit 0,1"));?>
...
<?php
				...
				$activelang_des=mysqli_query($con, "select * from sv_language where lang_status='1' order by lang_id asc");
